...
type QuerySize struct {
	...
	Size int32 `protobuf:"varint,1,opt,name=size,proto3" json:"size,omitempty"` // 页数量
}
...
type ProdResponseList struct {
	...
	Prodres []*ProdResponse `protobuf:"bytes,1,rep,name=prodres,proto3" json:"prodres,omitempty"` // ProdResponse: 上面的message，prodres: 自定义变量
}
...
var file_Prod_proto_rawDesc = []byte{
	...
	0x01, 0x43, 0x10, 0x02, 0x32, 0x81, 0x02, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x53, 0x65, 0x72,
	...
	0x5a, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x73,
	...
	0x74, 0x22, 0x18, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x12, 0x12, 0x10, 0x2f, 0x76, 0x31, 0x2f, 0x70,
	0x72, 0x6f, 0x64, 0x73, 0x2f, 0x7b, 0x73, 0x69, 0x7a, 0x65, 0x7d, 0x12, 0x3b, 0x0a, 0x0b, 0x47,
	0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x15, 0x2e, 0x73, 0x65, 0x72,
	...
	0x64, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x22, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
